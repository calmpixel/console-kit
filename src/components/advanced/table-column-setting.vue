...
<style>
/* Keep column-setting trigger flush when nested in NButtonGroup (Popover is not a direct NButton). */
.n-button-group > .n-popover {
  display: inline-flex;
  vertical-align: bottom;
}

.n-button-group > .n-popover .n-button {
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
  margin-left: -1px;
}

.n-button-group > .n-button:not(:first-child) + .n-popover .n-button,
.n-button-group > .n-popover:not(:first-child) .n-button {
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
}

.n-button-group > .n-popover:not(:last-child) .n-button {
