...
import { wrapTopLevelRoutesWithLayout } from './wrap-layout';
...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  async function initConstantRoute() {
    ...
    if (authRouteMode.value === 'static') {
      ...
      // dynamic: 登录/403/404 等仍用前端常量路由；业务菜单由 getUserRoutes 提供
  ...
  async function initDynamicAuthRoute() {
    ...
    if (!error) {
      ...
      addAuthRoutes(wrapTopLevelRoutesWithLayout(routes));
