...
/** Legacy Soybean template default; treat as unset so platform name is used */
const LEGACY_WATERMARK_TEXT = 'SoybeanAdmin';
...
export const useThemeStore = defineStore(SetupStoreId.Theme, () => {
  ...
  /** Watermark content: username / time / custom text, else platform name */
  const watermarkContent = computed(() => {
    ...
    if (text && text !== LEGACY_WATERMARK_TEXT) {
      return text;
    }

    return siteStore.platformName;
  });
